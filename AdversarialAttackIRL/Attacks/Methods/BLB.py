...
class BLBAttack(Attack):
    ...
    def __init__(self, model=None, init_const=1e-2, binary_search_steps=5, max_iterations=1000, num_classes=10):
        """
        ...
        """
        super(BLBAttack, self).__init__(model, num_classes=num_classes)
        self.model = model
    ...
    def perturbation(self, samples, ys_targets, batch_size, device):
        ...
        # L2 norm attack
        best_l2 = np.full(batch_size, 1e10)
        ...
        for search_for_c in range(self.binary_search_steps):
            ...
            # the following is in analogy to CW2 attack
